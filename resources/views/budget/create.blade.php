...
<head>
    ...
    <title>OBADIA - Add Budget Item</title>
...
<body>
    <div class="container">
        <!-- Header -->
        <header class="header">
            <h1><i class="fas fa-plus-circle"></i> Add Budget Item</h1>
        ...
        <div class="main-content">
            <div class="form-header">
                ...
                <p>Add a new item to your monthly budget tracking</p>
            </div>

            <!-- Info Box -->
            <div class="info-box">
                <h3><i class="fas fa-info-circle"></i> Budget Categories</h3>
                <p><strong>Bills:</strong> Essential monthly expenses (rent, utilities, insurance, etc.)</p>
                <p><strong>Wants:</strong> Non-essential purchases and entertainment</p>
                <p><strong>Savings:</strong> Money set aside for future goals</p>
                <p><strong>Debts:</strong> Loan payments, credit card payments, etc.</p>
            </div>
            ...
            <form method="POST" action="{{ route('budget.store') }}" id="budgetForm">
                    ...
                    <div class="category-selection">
                        <div class="category-option">
                            <input type="radio" id="bills" name="category" value="Bills" 
                                   {{ old('category') == 'Bills' ? 'checked' : '' }} required>
                        ...
                        <div class="category-option">
                            <input type="radio" id="wants" name="category" value="Wants" 
                                   {{ old('category') == 'Wants' ? 'checked' : '' }} required>
                        ...
                        <div class="category-option">
                            <input type="radio" id="savings" name="category" value="Savings" 
                                   {{ old('category') == 'Savings' ? 'checked' : '' }} required>
                        ...
                        <div class="category-option">
                            <input type="radio" id="debts" name="category" value="Debts" 
                                   {{ old('category') == 'Debts' ? 'checked' : '' }} required>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <div class="amount-input-group">
                            ...
                            <input type="number" id="budgeted_amount" name="budgeted_amount" 
                                   class="form-control" value="{{ old('budgeted_amount') }}" 
                    ...
                    <div class="form-group">
                        <label for="actual_amount">Actual Amount (Optional)</label>
                        <div class="amount-input-group">
                            <span class="currency-prefix">KSH</span>
                            <input type="number" id="actual_amount" name="actual_amount" 
                                   class="form-control" value="{{ old('actual_amount') }}" 
                                   min="0" step="0.01" max="999999.99" 
                                   placeholder="0.00">
                        </div>
                    </div>
                ...
                <div class="form-group full-width">
                    ...
                    <textarea id="notes" name="notes" class="form-control" 
                              placeholder="Any additional notes about this budget item...">{{ old('notes') }}</textarea>
                </div>

                <!-- Form Actions -->
                <div class="form-actions">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> Create Budget Item
                    </button>
